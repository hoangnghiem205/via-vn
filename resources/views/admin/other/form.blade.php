...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            @if(isset($other))
                {{ Form::model($other, ['route' => ['admin.other.update', $other->id], 'method' => 'patch', 'class' => 'form-horizontal']) }}
            @else
                {{ Form::open(['route' => 'admin.other.new', 'method' => 'post', 'class' => 'form-horizontal']) }}
            @endif

            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Other form</h3>
                </div>
