...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            @if(isset($service))
                {{ Form::model($service, ['route' => ['admin.services.update', $service->id], 'method' => 'patch', 'class' => 'form-horizontal']) }}
            @else
                {{ Form::open(['route' => 'admin.services.new', 'method' => 'post', 'class' => 'form-horizontal']) }}
            @endif
